...
- Query Planning：保留原始问题，并在复杂问题下拆出最多 3 个 sub-queries。
- Dense Retrieval：原始问题和每个 sub-query 都从 Qdrant 召回语义相近 chunk。
- BM25 Retrieval：原始问题和每个 sub-query 都从数据库正文召回词项匹配 chunk。
